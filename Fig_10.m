...
subplot(221);plot(t,real(Sig1),'k');hold on;plot(t,real(mode),'--c'); ylim([-3 4])
xlabel('Time (s)');ylabel('Amplitude');legend('Original','Reconstructed','Orientation','horizontal');
subplot(223);plot(t,real(Sig1-mode'),'r');xlabel('Time (s)');ylabel('Amplitude');lgd= legend('Error');lgd.Location = 'north'; ylim([-3 4])
subplot(222);plot(t,real(Sig2),'k');hold on;plot(t,mode2,'--c'); ylim([-3 4])
xlabel('Time (s)');ylabel('Amplitude');legend('Original','Reconstructed','Orientation','horizontal');
subplot(224);plot(t,real(Sig2-mode2'),'r');xlabel('Time (s)');ylabel('Amplitude'); ylim([-3 4])
xlabel('Time (s)');ylabel('Amplitude');lgd= legend('Error');lgd.Location = 'north';
