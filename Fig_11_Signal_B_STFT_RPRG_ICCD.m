...
Sig1 = am1.*exp(2*pi*1i*(-20*t.^2 + 90*t));    Sig1=Sig1';                 IF1 = -40*t + 90;
Sig2 = am2.*exp(2*pi*1i*(20*t.^2 + 10*t));     Sig2=Sig2';                 IF2 =  40*t + 10;
...
%
alpha2 = 0.5;
bw = SampFreq/40; %40; %  % bandwidth of the ICCD                         
orderIF = 5;
%
...
%         figure;subplot(211);plot(fidexmult(1,:));subplot(212);plot(findex(1,:))
